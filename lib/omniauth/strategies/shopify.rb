  ...
  module Strategies
    class Shopify < OmniAuth::Strategies::OAuth2
      ...
      def valid_scope?(token)
        ...
        scope = config[:scope]
        expected_api_access = OmniAuth::Shopify::ApiAccess.new(scope)
        actual_api_access = OmniAuth::Shopify::ApiAccess.new(token['scope'])
      ...
      def authorize_params
        super.tap do |params|
          ...
          params[:scope] = OmniAuth::Shopify::ApiAccess.new(scopes).to_s
